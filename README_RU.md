...
* MojoLauncher это лаунчер, основанный на [NexusLauncher](https://github.com/NexusLauncherTeam/NexusLauncher), позволяющий играть в Minecraft: Java Edition на устройствах Android!
...
## Введение 
* MojoLauncher это лаунчер Minecraft: Java Edition для Android основанный на [NexusLauncher](https://github.com/NexusLauncherTeam/NexusLauncher)
...
[![Google Play](https://play.google.com/intl/en_us/badges/static/images/badges/en_badge_web_generic.png)](https://play.google.com/store/apps/details?id=com.nexuslauncher.app)
...
- [NexusLauncher](https://github.com/NexusLauncherTeam/NexusLauncher): [GNU LGPLv3 License](https://github.com/NexusLauncherTeam/NexusLauncher/blob/v3_openjdk/LICENSE)
...
- [GL4ES](https://github.com/NexusLauncherTeam/gl4es): [MIT License](https://github.com/ptitSeb/gl4es/blob/master/LICENSE).<br>
- [OpenJDK](https://github.com/NexusLauncherTeam/openjdk-multiarch-jdk8u): [GNU GPLv2 License](https://openjdk.java.net/legal/gplv2+ce.html).<br>
